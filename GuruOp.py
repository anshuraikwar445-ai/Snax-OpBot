...
TOKEN = "8582282377:AAF42MKHlO684hv8LkaHgOOwQHy5FNUCYio"
OWNER_ID = int(os.getenv('OWNER_ID', 7633919939))
ADMIN_ID = int(os.getenv('ADMIN_ID', 7633919939))
YOUR_USERNAME = os.getenv('YOUR_USERNAME', 'GURUOP7572')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'GURU_DEVELOPERTG')

# Limits from .env or defaults
FREE_USER_LIMIT = int(os.getenv('FREE_USER_LIMIT', 7))
